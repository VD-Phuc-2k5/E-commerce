    ...
    utils.lib.eachDefaultSystem (
      ...
      let
        pkgs = import nixpkgs {
          ...
          # Bổ sung: overlay để đảm bảo maven/lombok dùng đúng jdk25
          overlays = [
            (final: prev: {
              jdk = prev.jdk25;
        ...
        devShells.default = pkgs.mkShell {
          ...
          shellHook =
            ...
            ''
              ...
              # Bổ sung: đưa jdk bin lên đầu PATH, tránh bị override bởi system java
              export PATH="${pkgs.jdk25}/bin:$PATH"
              # Bổ sung: kích hoạt lombok agent toàn cục cho mọi tool (mvn, gradle...)
